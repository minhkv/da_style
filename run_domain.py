...
save_path = saver.save(domain_adaptation.sess, "/content/drive/DaiHoc/ThucTap/Coding/da_style/model/step1/model_{}.ckpt".format(current_step))
...
save_path = saver.save(domain_adaptation.sess, "/content/drive/DaiHoc/ThucTap/Coding/da_style/model/step2/model_{}.ckpt".format(current_step))
